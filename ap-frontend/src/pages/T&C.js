    ...
    render() {
      return (
        <div style={{marginLeft:"15%", marginRight:"15%", paddingTop:"10%"}}>
            ...
            In addition to the general rules above, the provisions in this Section apply specifically to your use of Companies Content posted to Site. Companies Content on this Site, including without limitation the text, software, scripts, source code, API, graphics, photos, sounds, music, videos and interactive features and the trademarks, service marks and logos contained therein ("Companies Content"), are owned by or licensed to ESA in perpetuity, and are subject to copyright, trademark, and/or patent protection.
            ...
            You acknowledge and agree that your payment will be charged and processed by ESA.
            ...
            Refund Policy: for products and services eligible for a refund, you may request a refund under the terms and conditions of our Refund Policy which can be accessed.
            <br/> <br/>
            ...
            17. GOVERNING LAW
            This Agreement and any dispute or claim arising out of or in connection with it or its subject matter or formation shall be governed by and construed in accordance with the laws of India, Maharashtra, to the exclusion of conflict of law rules.

            <br/> <br/>

            18. DISPUTE RESOLUTION
            The courts of India, Maharashtra shall have exclusive jurisdiction to settle any dispute or claim that arises out of or in connection with this agreement or its subject matter or formation.
